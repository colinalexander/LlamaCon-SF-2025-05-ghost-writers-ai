...
async function testTavusVideoAPI() {
  console.log('Testing Tavus Video API with FIXED endpoint...');
  ...
  try {
    console.log('Making request to https://tavusapi.com/v2/videos...');
    ...
    const response = await fetch('https://tavusapi.com/v2/videos', {
      ...
      body: JSON.stringify({
        ...
        // Note: persona_id removed as it's not needed
...
async function testTavusConversationAPI() {
  console.log('\nTesting Tavus Conversation API with FIXED endpoint...');
  console.log('Using genre config:', genreConfig);
  console.log('API Key:', TAVUS_API_KEY.substring(0, 5) + '...');
  ...
  try {
    console.log('Making request to https://tavusapi.com/v2/conversations...');
